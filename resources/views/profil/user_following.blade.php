...
<html lang="en" style="background: #f0ecec">
  <head>
    ...
    <link rel="stylesheet" href="/user/user_following.css" />
  </head>
  <body class="mx-auto">
    <!-- nav header -->
    <div class="d-flex justify-content-between py-2 px-3 nav my-auto">
      <div class="logo_x" onclick="history.back()"></div>
      <span class="header_title">Following</span>
      <div></div>
    </div>
    ...
    <div class="pb-5 pt-3 main">
        @foreach ($list_following as $x)
            <div class="d-flex justify-content-between px-3 py-2">
                <a class="text-decoration-none" href="/user/{{$x->following}}">
                <div class="d-flex">
